...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tafe_course', 'year',
                      self.gf('django.db.models.fields.CharField')(default=2012, max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.year'
        db.delete_column('tafe_course', 'year')
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
