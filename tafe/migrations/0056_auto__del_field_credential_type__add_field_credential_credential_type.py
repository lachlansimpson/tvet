...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Credential.credential_type'
        db.add_column('tafe_credential', 'credential_type',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Credential.type'
        raise RuntimeError("Cannot reverse this migration. 'Credential.type' and its values cannot be restored.")
        # Deleting field 'Credential.credential_type'
        db.delete_column('tafe_credential', 'credential_type')
