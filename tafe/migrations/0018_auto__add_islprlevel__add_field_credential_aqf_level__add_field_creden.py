...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ISLPRLevel'
        db.create_table('tafe_islprlevel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reading', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('writing', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('speaking', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('listening', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('overall', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('tafe', ['ISLPRLevel'])

        # Adding field 'Credential.aqf_level'
        db.add_column('tafe_credential', 'aqf_level',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=2),
                      keep_default=False)

        # Adding field 'Credential.institution'
        db.add_column('tafe_credential', 'institution',
                      self.gf('django.db.models.fields.CharField')(default='Instiute', max_length=40),
                      keep_default=False)

        # Adding field 'Credential.year'
        db.add_column('tafe_credential', 'year',
                      self.gf('django.db.models.fields.CharField')(default='1976', max_length=4),
                      keep_default=False)

        # Adding field 'Credential.type'
        db.add_column('tafe_credential', 'type',
                      self.gf('django.db.models.fields.CharField')(default='L', max_length=1),
                      keep_default=False)

        # Deleting field 'Staff.credential'
        db.delete_column('tafe_staff', 'credential_id')

        # Adding M2M table for field credential on 'Staff'
        db.create_table('tafe_staff_credential', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('staff', models.ForeignKey(orm['tafe.staff'], null=False)),
            ('credential', models.ForeignKey(orm['tafe.credential'], null=False))
        ))
        db.create_unique('tafe_staff_credential', ['staff_id', 'credential_id'])


    def backwards(self, orm):
        # Deleting model 'ISLPRLevel'
        db.delete_table('tafe_islprlevel')

        # Deleting field 'Credential.aqf_level'
        db.delete_column('tafe_credential', 'aqf_level')

        # Deleting field 'Credential.institution'
        db.delete_column('tafe_credential', 'institution')

        # Deleting field 'Credential.year'
        db.delete_column('tafe_credential', 'year')

        # Deleting field 'Credential.type'
        db.delete_column('tafe_credential', 'type')

        # Adding field 'Staff.credential'
        db.add_column('tafe_staff', 'credential',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tafe.Credential'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field credential on 'Staff'
        db.delete_table('tafe_staff_credential')
