...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StaffAttendance'
        db.create_table('tafe_staffattendance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='staffattendance_attendance_records', to=orm['tafe.Session'])),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('absent', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True)),
            ('last_change_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='staffattendance_last_change_by', to=orm['auth.User'])),
            ('penultimate_change_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='staffattendance_penultimate_change_by', null=True, to=orm['auth.User'])),
            ('staff', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attendance_records', to=orm['tafe.Staff'])),
        ))
        db.send_create_signal('tafe', ['StaffAttendance'])

        # Adding model 'StudentAttendance'
        db.create_table('tafe_studentattendance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='studentattendance_attendance_records', to=orm['tafe.Session'])),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('absent', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True)),
            ('last_change_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='studentattendance_last_change_by', to=orm['auth.User'])),
            ('penultimate_change_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='studentattendance_penultimate_change_by', null=True, to=orm['auth.User'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attendance_records', to=orm['tafe.Student'])),
        ))
        db.send_create_signal('tafe', ['StudentAttendance'])


    def backwards(self, orm):
        # Adding model 'Attendance'
        db.create_table('tafe_attendance', (
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attendance_records', to=orm['tafe.Session'])),
            ('absent', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('penultimate_change_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attendance_penultimate_change_by', null=True, to=orm['auth.User'], blank=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attendance_records', to=orm['tafe.Student'])),
            ('last_change_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attendance_last_change_by', to=orm['auth.User'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True)),
        ))
        db.send_create_signal('tafe', ['Attendance'])

        # Deleting model 'StaffAttendance'
        db.delete_table('tafe_staffattendance')

        # Deleting model 'StudentAttendance'
        db.delete_table('tafe_studentattendance')
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tafe.staffattendance': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'blank': 'True'}),
            'staff': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attendance_records'", 'to': "orm['tafe.Staff']"})
        },
        'tafe.student': {
