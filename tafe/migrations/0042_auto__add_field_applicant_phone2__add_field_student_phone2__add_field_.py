...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.phone2'
        db.add_column('tafe_applicant', 'phone2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=12, blank=True),
                      keep_default=False)

        # Adding field 'Student.phone2'
        db.add_column('tafe_student', 'phone2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=12, blank=True),
                      keep_default=False)

        # Adding field 'Staff.phone2'
        db.add_column('tafe_staff', 'phone2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=12, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.phone2'
        db.delete_column('tafe_applicant', 'phone2')

        # Deleting field 'Student.phone2'
        db.delete_column('tafe_student', 'phone2')

        # Deleting field 'Staff.phone2'
        db.delete_column('tafe_staff', 'phone2')
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
