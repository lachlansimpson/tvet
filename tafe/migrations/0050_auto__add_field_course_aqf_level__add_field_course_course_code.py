...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.aqf_level'
        db.add_column('tafe_course', 'aqf_level',
                      self.gf('django.db.models.fields.CharField')(default='OTH', max_length=5),
                      keep_default=False)

        # Adding field 'Course.course_code'
        db.add_column('tafe_course', 'course_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.aqf_level'
        db.delete_column('tafe_course', 'aqf_level')

        # Deleting field 'Course.course_code'
        db.delete_column('tafe_course', 'course_code')
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 28, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
