...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.date_of_application'
        db.add_column('tafe_applicant', 'date_of_application',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.date_of_application'
        db.delete_column('tafe_applicant', 'date_of_application')
    ...
    models = {
        ...
        'tafe.staff': {
            'ISLPR_level': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'staff_levels'", 'null': 'True', 'to': "orm['tafe.ISLPRLevel']"}),
