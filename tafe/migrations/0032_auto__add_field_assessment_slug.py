...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.slug'
        db.add_column('tafe_assessment', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='emptystring', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.slug'
        db.delete_column('tafe_assessment', 'slug')
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
