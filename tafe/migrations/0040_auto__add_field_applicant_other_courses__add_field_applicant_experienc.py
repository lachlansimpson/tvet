...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.other_courses'
        db.add_column('tafe_applicant', 'other_courses',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Applicant.experience'
        db.add_column('tafe_applicant', 'experience',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.other_courses'
        db.delete_column('tafe_applicant', 'other_courses')

        # Deleting field 'Applicant.experience'
        db.delete_column('tafe_applicant', 'experience')
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
