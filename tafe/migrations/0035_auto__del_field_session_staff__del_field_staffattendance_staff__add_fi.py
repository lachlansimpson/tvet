...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Session.staff'
        db.delete_column('tafe_session', 'staff_id')

        # Deleting field 'StaffAttendance.staff'
        db.delete_column('tafe_staffattendance', 'staff_id')

        # Adding field 'StaffAttendance.session'
        db.add_column('tafe_staffattendance', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='staffattendance_attendance_records', to=orm['tafe.Session']),
                      keep_default=False)

        # Adding field 'StaffAttendance.staff_member'
        db.add_column('tafe_staffattendance', 'staff_member',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='attendance_records', to=orm['tafe.Staff']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Session.staff'
        db.add_column('tafe_session', 'staff',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tafe.StaffAttendance'], unique=True, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'StaffAttendance.staff'
        raise RuntimeError("Cannot reverse this migration. 'StaffAttendance.staff' and its values cannot be restored.")
        # Deleting field 'StaffAttendance.session'
        db.delete_column('tafe_staffattendance', 'session_id')

        # Deleting field 'StaffAttendance.staff_member'
        db.delete_column('tafe_staffattendance', 'staff_member_id')
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
