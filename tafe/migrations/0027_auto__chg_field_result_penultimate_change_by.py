...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Result.penultimate_change_by'
        db.alter_column('tafe_result', 'penultimate_change_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Result.penultimate_change_by'
        raise RuntimeError("Cannot reverse this migration. 'Result.penultimate_change_by' and its values cannot be restored.")
