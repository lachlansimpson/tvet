...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.education_level'
        db.alter_column('tafe_student', 'education_level', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Student.education_level'
        db.alter_column('tafe_student', 'education_level', self.gf('django.db.models.fields.CharField')(max_length=50))
