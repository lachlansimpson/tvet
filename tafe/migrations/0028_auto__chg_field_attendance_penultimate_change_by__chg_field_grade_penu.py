...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attendance.penultimate_change_by'
        db.alter_column('tafe_attendance', 'penultimate_change_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Grade.penultimate_change_by'
        db.alter_column('tafe_grade', 'penultimate_change_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Attendance.penultimate_change_by'
        raise RuntimeError("Cannot reverse this migration. 'Attendance.penultimate_change_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Grade.penultimate_change_by'
        raise RuntimeError("Cannot reverse this migration. 'Grade.penultimate_change_by' and its values cannot be restored.")
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 2, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
