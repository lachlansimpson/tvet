...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ISLPR_record'
        db.create_table('tafe_islpr_record', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('islpr_reading', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('islpr_writing', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('islpr_speaking', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('islpr_listening', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('islpr_overall', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('date_tested', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('tafe', ['ISLPR_record'])

        # Adding field 'Applicant.islpr_records'
        db.add_column('tafe_applicant', 'islpr_records',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='applicant_ISLPR_records', null=True, to=orm['tafe.ISLPR_record']),
                      keep_default=False)

        # Adding field 'Student.islpr_records'
        db.add_column('tafe_student', 'islpr_records',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='student_ISLPR_records', null=True, to=orm['tafe.ISLPR_record']),
                      keep_default=False)

        # Deleting field 'Staff.islpr_writing'
        db.delete_column('tafe_staff', 'islpr_writing')

        # Deleting field 'Staff.islpr_reading'
        db.delete_column('tafe_staff', 'islpr_reading')

        # Deleting field 'Staff.islpr_speaking'
        db.delete_column('tafe_staff', 'islpr_speaking')

        # Deleting field 'Staff.islpr_listening'
        db.delete_column('tafe_staff', 'islpr_listening')

        # Deleting field 'Staff.islpr_overall'
        db.delete_column('tafe_staff', 'islpr_overall')

        # Adding field 'Staff.islpr_records'
        db.add_column('tafe_staff', 'islpr_records',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='staff_ISLPR_records', null=True, to=orm['tafe.ISLPR_record']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ISLPR_record'
        db.delete_table('tafe_islpr_record')

        # Deleting field 'Applicant.islpr_records'
        db.delete_column('tafe_applicant', 'islpr_records_id')

        # Deleting field 'Student.islpr_records'
        db.delete_column('tafe_student', 'islpr_records_id')


        # User chose to not deal with backwards NULL issues for 'Staff.islpr_writing'
        raise RuntimeError("Cannot reverse this migration. 'Staff.islpr_writing' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Staff.islpr_reading'
        raise RuntimeError("Cannot reverse this migration. 'Staff.islpr_reading' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Staff.islpr_speaking'
        raise RuntimeError("Cannot reverse this migration. 'Staff.islpr_speaking' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Staff.islpr_listening'
        raise RuntimeError("Cannot reverse this migration. 'Staff.islpr_listening' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Staff.islpr_overall'
        raise RuntimeError("Cannot reverse this migration. 'Staff.islpr_overall' and its values cannot be restored.")
        # Deleting field 'Staff.islpr_records'
        db.delete_column('tafe_staff', 'islpr_records_id')
    ...
    models = {
        ...
        'tafe.applicant': {
            ...
            'islpr_records': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'applicant_ISLPR_records'", 'null': 'True', 'to': "orm['tafe.ISLPR_record']"}),
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tafe.staff': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'island': ('django.db.models.fields.CharField', [], {'default': "'Tarawa'", 'max_length': "'10'", 'null': 'True', 'blank': 'True'}),
            'islpr_records': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'staff_ISLPR_records'", 'null': 'True', 'to': "orm['tafe.ISLPR_record']"}),
        ...
        'tafe.student': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'island': ('django.db.models.fields.CharField', [], {'default': "'Tarawa'", 'max_length': "'10'", 'null': 'True', 'blank': 'True'}),
            'islpr_records': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'student_ISLPR_records'", 'null': 'True', 'to': "orm['tafe.ISLPR_record']"}),
