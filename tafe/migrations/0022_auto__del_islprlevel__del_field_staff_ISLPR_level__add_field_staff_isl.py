...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Staff.islpr_reading'
        db.add_column('tafe_staff', 'islpr_reading',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=2),
                      keep_default=False)

        # Adding field 'Staff.islpr_writing'
        db.add_column('tafe_staff', 'islpr_writing',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=2),
                      keep_default=False)

        # Adding field 'Staff.islpr_speaking'
        db.add_column('tafe_staff', 'islpr_speaking',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=2),
                      keep_default=False)

        # Adding field 'Staff.islpr_listening'
        db.add_column('tafe_staff', 'islpr_listening',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=2),
                      keep_default=False)

        # Adding field 'Staff.islpr_overall'
        db.add_column('tafe_staff', 'islpr_overall',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('tafe_staff', 'ISLPR_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='staff_levels', null=True, to=orm['tafe.ISLPRLevel'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
