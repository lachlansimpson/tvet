...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.last_change_by'
        db.alter_column('tafe_applicant', 'last_change_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Student.last_change_by'
        db.alter_column('tafe_student', 'last_change_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Staff.last_change_by'
        db.alter_column('tafe_staff', 'last_change_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Applicant.last_change_by'
        raise RuntimeError("Cannot reverse this migration. 'Applicant.last_change_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Student.last_change_by'
        raise RuntimeError("Cannot reverse this migration. 'Student.last_change_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Staff.last_change_by'
        raise RuntimeError("Cannot reverse this migration. 'Staff.last_change_by' and its values cannot be restored.")
