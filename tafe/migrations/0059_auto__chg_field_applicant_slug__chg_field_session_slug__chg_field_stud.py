...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.slug'
        db.alter_column('tafe_applicant', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=62))

        # Changing field 'Session.slug'
        db.alter_column('tafe_session', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=140))

        # Changing field 'Student.slug'
        db.alter_column('tafe_student', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=62))

        # Changing field 'Enrolment.slug'
        db.alter_column('tafe_enrolment', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=110))

        # Changing field 'StaffAttendance.slug'
        ...
        db.alter_column('tafe_staff', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=62))

    def backwards(self, orm):

        # Changing field 'Applicant.slug'
        db.alter_column('tafe_applicant', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=40))

        # Changing field 'Session.slug'
        db.alter_column('tafe_session', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=90))

        # Changing field 'Student.slug'
        db.alter_column('tafe_student', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=40))

        # Changing field 'Enrolment.slug'
        db.alter_column('tafe_enrolment', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=40))

        # Changing field 'StaffAttendance.slug'
        db.alter_column('tafe_staffattendance', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Grade.slug'
        db.alter_column('tafe_grade', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=60))

        # Changing field 'StudentAttendance.slug'
        db.alter_column('tafe_studentattendance', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 31, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
