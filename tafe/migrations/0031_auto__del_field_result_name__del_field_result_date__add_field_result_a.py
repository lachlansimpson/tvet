...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('tafe_result', 'name')

        # Deleting field 'Result.date'
        db.delete_column('tafe_result', 'date')

        # Adding field 'Result.assessment'
        db.add_column('tafe_result', 'assessment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['tafe.Assessment']),
                      keep_default=False)

        # Adding field 'Result.date_submitted'
        db.add_column('tafe_result', 'date_submitted',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Result.name'
        raise RuntimeError("Cannot reverse this migration. 'Result.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Result.date'
        raise RuntimeError("Cannot reverse this migration. 'Result.date' and its values cannot be restored.")
        # Deleting field 'Result.assessment'
        db.delete_column('tafe_result', 'assessment_id')

        # Deleting field 'Result.date_submitted'
        db.delete_column('tafe_result', 'date_submitted')
    ...
    models = {
        ...
        'tafe.attendance': {
            ...
            'penultimate_change_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'attendance_penultimate_change_by'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
