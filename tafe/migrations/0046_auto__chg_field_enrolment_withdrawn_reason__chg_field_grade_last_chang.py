...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Enrolment.withdrawn_reason'
        db.alter_column('tafe_enrolment', 'withdrawn_reason', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Grade.last_change_by'
        db.alter_column('tafe_grade', 'last_change_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Enrolment.withdrawn_reason'
        db.alter_column('tafe_enrolment', 'withdrawn_reason', self.gf('django.db.models.fields.CharField')(max_length=200))

        # User chose to not deal with backwards NULL issues for 'Grade.last_change_by'
        raise RuntimeError("Cannot reverse this migration. 'Grade.last_change_by' and its values cannot be restored.")
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'withdrawn_reason': ('django.db.models.fields.CharField', [], {'max_length': '8', 'blank': 'True'})
        },
        'tafe.grade': {
