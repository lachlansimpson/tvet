...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'StaffAttendance.session'
        raise RuntimeError("Cannot reverse this migration. 'StaffAttendance.session' and its values cannot be restored.")
    ...
    models = {
        ...
        'tafe.session': {
            ...
            'staff': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['tafe.StaffAttendance']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
