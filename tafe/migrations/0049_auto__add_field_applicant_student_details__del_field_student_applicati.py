...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.student_details'
        db.add_column('tafe_applicant', 'student_details',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tafe.Student'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Applicant.student_details'
        db.delete_column('tafe_applicant', 'student_details_id')


        # User chose to not deal with backwards NULL issues for 'Student.application_details'
        raise RuntimeError("Cannot reverse this migration. 'Student.application_details' and its values cannot be restored.")
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
