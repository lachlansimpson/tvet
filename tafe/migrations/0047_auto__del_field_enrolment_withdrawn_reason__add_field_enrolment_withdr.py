...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Enrolment.withdrawal_reason'
        db.add_column('tafe_enrolment', 'withdrawal_reason',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Enrolment.withdrawal_reason'
        db.delete_column('tafe_enrolment', 'withdrawal_reason')
