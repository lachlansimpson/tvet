...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tafe_session', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2012, 9, 13, 0, 0), max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.slug'
        db.delete_column('tafe_session', 'slug')
