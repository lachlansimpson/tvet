...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'QualificationGraduated'
        db.create_table('tafe_qualificationgraduated', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('tafe', ['QualificationGraduated'])

        # Adding model 'Result'
        db.create_table('tafe_result', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('mark', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('tafe', ['Result'])


        # Changing field 'Grade.results'
        db.alter_column('tafe_grade', 'results_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tafe.Result']))
        # Adding field 'Staff.qualifications_achieved'
        db.add_column('tafe_staff', 'qualifications_achieved',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['tafe.QualificationGraduated']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'QualificationGraduated'
        db.delete_table('tafe_qualificationgraduated')

        # Deleting model 'Result'
        db.delete_table('tafe_result')


        # Changing field 'Grade.results'
        db.alter_column('tafe_grade', 'results_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tafe.SubjectResults']))
        # Deleting field 'Staff.qualifications_achieved'
        db.delete_column('tafe_staff', 'qualifications_achieved_id')
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tafe.qualificationgraduated': {
            'Meta': {'object_name': 'QualificationGraduated'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tafe.staff': {
            ...
            'island': ('django.db.models.fields.CharField', [], {'default': "'01'", 'max_length': "'2'", 'null': 'True', 'blank': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '12', 'blank': 'True'}),
            'qualifications_achieved': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tafe.QualificationGraduated']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '40', 'blank': 'True'}),
            'surname': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
