...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.island'
        db.alter_column('tafe_applicant', 'island', self.gf('django.db.models.fields.CharField')(max_length='10', null=True))

        # Changing field 'Student.island'
        db.alter_column('tafe_student', 'island', self.gf('django.db.models.fields.CharField')(max_length='10', null=True))

        # Changing field 'Credential.aqf_level'
        db.alter_column('tafe_credential', 'aqf_level', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Staff.island'
        db.alter_column('tafe_staff', 'island', self.gf('django.db.models.fields.CharField')(max_length='10', null=True))

    def backwards(self, orm):

        # Changing field 'Applicant.island'
        db.alter_column('tafe_applicant', 'island', self.gf('django.db.models.fields.CharField')(max_length='2', null=True))

        # Changing field 'Student.island'
        db.alter_column('tafe_student', 'island', self.gf('django.db.models.fields.CharField')(max_length='2', null=True))

        # Changing field 'Credential.aqf_level'
        db.alter_column('tafe_credential', 'aqf_level', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
