...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subject.year'
        db.alter_column('tafe_subject', 'year', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'Subject.year'
        db.alter_column('tafe_subject', 'year', self.gf('django.db.models.fields.IntegerField')())
