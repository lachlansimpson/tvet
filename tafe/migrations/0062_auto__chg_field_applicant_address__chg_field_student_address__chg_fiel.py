...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.address'
        db.alter_column('tafe_applicant', 'address', self.gf('django.db.models.fields.CharField')(max_length='11', null=True))

        # Changing field 'Student.address'
        db.alter_column('tafe_student', 'address', self.gf('django.db.models.fields.CharField')(max_length='11', null=True))

        # Changing field 'Staff.address'
        db.alter_column('tafe_staff', 'address', self.gf('django.db.models.fields.CharField')(max_length='11', null=True))

    def backwards(self, orm):

        # Changing field 'Applicant.address'
        db.alter_column('tafe_applicant', 'address', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Student.address'
        db.alter_column('tafe_student', 'address', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Staff.address'
        db.alter_column('tafe_staff', 'address', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        'tafe.applicant': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': "'11'", 'null': 'True', 'blank': 'True'}),
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
