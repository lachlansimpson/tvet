...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tafe_applicant', (
            ...
            ('island', self.gf('django.db.models.fields.CharField')(default='01', max_length='2', null=True, blank=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=12, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('disability', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('disability_description', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('applied_for', self.gf('django.db.models.fields.related.ForeignKey')(related_name='applicants', to=orm['tafe.Course'])),
            ('education_level', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('successful', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('short_listed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('test_ap', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('test_ma', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('test_eng', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('ranking', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('eligablility', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_offer_sent', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_offer_accepted', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('tafe', ['Applicant'])


        # Changing field 'Student.island'
        db.alter_column('tafe_student', 'island', self.gf('django.db.models.fields.CharField')(max_length='2', null=True))

        # Changing field 'Staff.island'
        db.alter_column('tafe_staff', 'island', self.gf('django.db.models.fields.CharField')(max_length='2', null=True))

    def backwards(self, orm):
        # Deleting model 'Applicant'
        db.delete_table('tafe_applicant')


        # Changing field 'Student.island'
        db.alter_column('tafe_student', 'island', self.gf('django.db.models.fields.CharField')(max_length='2'))

        # Changing field 'Staff.island'
        db.alter_column('tafe_staff', 'island', self.gf('django.db.models.fields.CharField')(max_length='2'))
    ...
    models = {
        'tafe.applicant': {
            ...
            'eligablility': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
