...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StaffISLPR'
        db.create_table('tafe_staffislpr', (
            ...
            ('staff_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='staff', to=orm['tafe.Staff'])),
        ))
        db.send_create_signal('tafe', ['StaffISLPR'])

        # Adding model 'StudentISLPR'
        db.create_table('tafe_studentislpr', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('islpr_reading', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('islpr_writing', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('islpr_speaking', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ...
            ('islpr_overall', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('date_tested', self.gf('django.db.models.fields.DateField')()),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='student', to=orm['tafe.Student'])),
        ))
        db.send_create_signal('tafe', ['StudentISLPR'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'StaffISLPR'
        db.delete_table('tafe_staffislpr')

        # Deleting model 'StudentISLPR'
        db.delete_table('tafe_studentislpr')

        # Adding field 'Applicant.islpr_records'
        db.add_column('tafe_applicant', 'islpr_records',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='applicant_ISLPR_records', null=True, to=orm['tafe.ISLPR_record'], blank=True),
                      keep_default=False)

        # Adding field 'Student.islpr_records'
        db.add_column('tafe_student', 'islpr_records',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='student_ISLPR_records', null=True, to=orm['tafe.ISLPR_record'], blank=True),
                      keep_default=False)

        # Adding field 'Staff.islpr_records'
        db.add_column('tafe_staff', 'islpr_records',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='staff_ISLPR_records', null=True, to=orm['tafe.ISLPR_record'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'tafe.staffislpr': {
            ...
            'staff_member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'staff'", 'to': "orm['tafe.Staff']"})
        },
        'tafe.student': {
        ...
        'tafe.studentislpr': {
            ...
            'islpr_speaking': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'islpr_writing': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'student'", 'to': "orm['tafe.Student']"})
        },
        'tafe.subject': {
