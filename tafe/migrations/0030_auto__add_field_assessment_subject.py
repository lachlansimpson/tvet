...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.subject'
        db.add_column('tafe_assessment', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['tafe.Subject']),
                      keep_default=False)

        # Removing M2M table for field assessments on 'Subject'
        db.delete_table('tafe_subject_assessments')


    def backwards(self, orm):
        # Deleting field 'Assessment.subject'
        db.delete_column('tafe_assessment', 'subject_id')

        # Adding M2M table for field assessments on 'Subject'
        db.create_table('tafe_subject_assessments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subject', models.ForeignKey(orm['tafe.subject'], null=False)),
            ('assessment', models.ForeignKey(orm['tafe.assessment'], null=False))
        ))
        db.create_unique('tafe_subject_assessments', ['subject_id', 'assessment_id'])
    ...
    models = {
        ...
        'tafe.enrolment': {
            ...
            'date_started': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 4, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
