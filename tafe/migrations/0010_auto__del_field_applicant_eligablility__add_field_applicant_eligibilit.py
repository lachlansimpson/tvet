...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Applicant.eligablility'
        db.delete_column('tafe_applicant', 'eligablility')

        # Adding field 'Applicant.eligibility'
        db.add_column('tafe_applicant', 'eligibility',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Applicant.eligablility'
        db.add_column('tafe_applicant', 'eligablility',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Applicant.eligibility'
        db.delete_column('tafe_applicant', 'eligibility')
