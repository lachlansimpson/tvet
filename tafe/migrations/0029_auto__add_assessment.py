...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tafe_assessment', (
        ...
        db.send_create_signal('tafe', ['Assessment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tafe_assessment')
    ...
    models = {
        ...
        'tafe.subject': {
            ...
            'assessments': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['tafe.Assessment']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
