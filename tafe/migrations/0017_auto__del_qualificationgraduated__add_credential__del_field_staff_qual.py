...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tafe_credential', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('tafe', ['Credential'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tafe_credential')

        # Adding field 'Staff.qualifications_achieved'
        db.add_column('tafe_staff', 'qualifications_achieved',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tafe.QualificationGraduated'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'tafe.staff': {
            ...
            'credential': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tafe.Credential']", 'null': 'True', 'blank': 'True'}),
            'disability': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'disability_description': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'dob': ('django.db.models.fields.DateField', [], {}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
