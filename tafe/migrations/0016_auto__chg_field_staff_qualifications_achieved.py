...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Staff.qualifications_achieved'
        db.alter_column('tafe_staff', 'qualifications_achieved_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tafe.QualificationGraduated'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Staff.qualifications_achieved'
        raise RuntimeError("Cannot reverse this migration. 'Staff.qualifications_achieved' and its values cannot be restored.")
    ...
    models = {
        ...
        'tafe.staff': {
            ...
            'island': ('django.db.models.fields.CharField', [], {'default': "'01'", 'max_length': "'2'", 'null': 'True', 'blank': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '12', 'blank': 'True'}),
            'qualifications_achieved': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tafe.QualificationGraduated']", 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '40', 'blank': 'True'}),
            'surname': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
