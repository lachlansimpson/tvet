...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.address'
        db.add_column('tafe_applicant', 'address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Subject.name'
        db.alter_column('tafe_subject', 'name', self.gf('django.db.models.fields.CharField')(max_length=125))

        # Changing field 'Subject.slug'
        db.alter_column('tafe_subject', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=135))
        # Adding field 'Student.address'
        db.add_column('tafe_student', 'address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Enrolment.semester_1_payment'
        db.add_column('tafe_enrolment', 'semester_1_payment',
                      self.gf('django.db.models.fields.CharField')(default='N', max_length=1),
                      keep_default=False)

        # Adding field 'Enrolment.semester_1_payment_receipt'
        db.add_column('tafe_enrolment', 'semester_1_payment_receipt',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Enrolment.semester_2_payment'
        db.add_column('tafe_enrolment', 'semester_2_payment',
                      self.gf('django.db.models.fields.CharField')(default='N', max_length=1),
                      keep_default=False)

        # Adding field 'Enrolment.semester_2_payment_receipt'
        db.add_column('tafe_enrolment', 'semester_2_payment_receipt',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.address'
        db.add_column('tafe_staff', 'address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.address'
        db.delete_column('tafe_applicant', 'address')


        # Changing field 'Subject.name'
        db.alter_column('tafe_subject', 'name', self.gf('django.db.models.fields.CharField')(max_length=65))

        # Changing field 'Subject.slug'
        db.alter_column('tafe_subject', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=70))
        # Deleting field 'Student.address'
        db.delete_column('tafe_student', 'address')

        # Deleting field 'Enrolment.semester_1_payment'
        db.delete_column('tafe_enrolment', 'semester_1_payment')

        # Deleting field 'Enrolment.semester_1_payment_receipt'
        db.delete_column('tafe_enrolment', 'semester_1_payment_receipt')

        # Deleting field 'Enrolment.semester_2_payment'
        db.delete_column('tafe_enrolment', 'semester_2_payment')

        # Deleting field 'Enrolment.semester_2_payment_receipt'
        db.delete_column('tafe_enrolment', 'semester_2_payment_receipt')

        # Deleting field 'Staff.address'
        db.delete_column('tafe_staff', 'address')
