...
class SessionRecurringForm(forms.Form):
    ...
    recurring = forms.BooleanField(help_text="Does this class happen every week")
    for_semester = forms.BooleanField(help_text="Will it happen for the whole semester")
