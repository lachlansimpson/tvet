...
from tafe.views import session_create, session_view, session_attendance_view, timetable_daily_view, units_by_qualifications_view, unit_view, assessment_view, student_reports, applicant_reports, reports, applicant_qualification, applicant_shortlist, applicant_shortlist_qualification, unit_add_assessment_view #, assessment_mark_view
...
urlpatterns = patterns('tafe.views',
    ...
    #url(r'^unit/(?P<unit>[-\w]+)/assessment/(?P<slug>[-\w]+)/mark/$', assessment_mark_view, name='assessment_mark_view'),
