...
from tafe.views import session_create, session_view, session_attendance_view, attendance_view, timetable_daily_view, units_by_qualifications_view, unit_view
